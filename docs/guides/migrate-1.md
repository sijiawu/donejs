...
If you have a `messages` component in `src/messages/`, the following pages should work correctly:

- demo page: [http://localhost:8080/src/messages/messages.html]
- test page: [http://localhost:8080/src/messages/test.html]

You can also make things easier on yourself by following the [CanJS 3 pre-migration preparation](https://canjs.com/doc/migrate-3.html#Pre_migrationpreparation) steps _before_ going through the rest of this guide. The pre-migration section of the [CanJS 3 migration guide](https://canjs.com/doc/migrate-3.html) includes changes you can make to your existing CanJS 2.3 app that will make migrating to CanJS 3 easier.
...
At this point, your [development.html](http://localhost:8080/development.html) and [src/test.html](http://localhost:8080/src/test.html) should start working. Not all of your tests may pass, but you should be able to load the test page and see results.
